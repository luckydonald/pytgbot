...
### Version [2.3.1 (stable)](https://github.com/luckydonald/pytgbot/blob/master/CHANGELOG.md#changelog) [![Join pytgbot group on telegram](https://img.shields.io/badge/Telegram%20Group-Join-blue.svg)](https://telegram.me/pytg_group)
...
#### Recent changes:
 - Official API changes of [`Bot API 2.3.1` (November 21, 2016)](https://core.telegram.org/bots/api-changelog#november-21-2016)
