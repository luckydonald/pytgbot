...
class WebhookInfoModel(BaseModel):  # Receivable
    ...
    last_error_date: Optional['datetime.datetimeModel']
...
class MessageModel(BaseModel):  # UpdateType
    ...
    forward_date: Optional['datetime.datetimeModel']
    reply_to_message: Optional['MessageModel']
    via_bot: Optional['UserModel']
    edit_date: Optional['datetime.datetimeModel']
...
class PollModel(BaseModel):  # Media
    ...
    close_date: Optional['datetime.datetimeModel']
# end class Poll
...
class ChatMemberModel(BaseModel):  # Result
    ...
    until_date: Optional['datetime.datetimeModel']
...
class PassportFileModel(BaseModel):  # Result
    ...
    file_unique_id: str
    file_size: int
    file_date: 'datetime.datetimeModel'
