...
class PassportFile(Result):
    ...
    def __init__(self, file_id, file_unique_id, file_size, file_date, _raw=None):
        ...
        assert_type_or_raise(file_date, datetime.datetime, parameter_name="file_date")
    ...
    def to_array(self):
        ...
        array['file_date'] = self.file_date.to_array()  # type datetime.datetime
    ...
    def validate_array(array):
        ...
        data['file_date'] = datetime.datetime.from_array(array.get('file_date'))
        return data
    # end def validate_array
